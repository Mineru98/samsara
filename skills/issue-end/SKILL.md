---
name: issue-end
description: issue-start 작업을 마무리해 증거를 확정하고 PR 을 만듭니다. merge 는 issue-merge 로 넘깁니다. `/issue-end`, `$issue-end`, "이슈 마무리", "작업 종료", "승인한 작업 PR" 요청에 사용.
---
...
```text
skills/issue-end              # 플러그인 루트 (Claude Code / Codex)
