...
import {
  mkdirSync, existsSync, readFileSync, writeFileSync, writeSync, cpSync, readdirSync, rmSync, realpathSync, lstatSync, unlinkSync, openSync, closeSync, fstatSync, ftruncateSync, constants,
} from 'node:fs';
